# Solve It Readiness Lab — UI/UX DATA SHEET V2.2.3
Version: 2.2.3 — Consolidated Navigation, Workspace, Integrated Results Review, Global Chart Data-Point Visibility, Contextual Graph Selection & Decision-Ready Written Report Lock
...
- units are supplied by the field component and should not be redundantly repeated in adjacent prose;
