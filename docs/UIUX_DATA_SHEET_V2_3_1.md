# DecisionLab — UI/UX DATA SHEET V2.3.1
Version: 2.3.1 — DecisionLab Brand, Client Advisory Workspace, Unified Sidebar Navigation, Expanded Sea Wolf Canvas, Contextual Next-Site Intelligence
Status: CONSOLIDATED SOURCE OF TRUTH — V2.3.1 SHELL/WORKSPACE AMENDMENT + LOCKED V2.2.15 RED ROCK / SEA WOLF MECHANICS
Purpose: Master implementation specification for the DecisionLab Client Advisory Workspace. V2.3.1 changes the learner-facing application shell, navigation and selected Sea Wolf decision-support presentation while preserving the locked task data, mechanics and scoring inherited from V2.2.15.

> Important: DecisionLab remains an independent educational practice application. It must not present itself as an official McKinsey product, reproduce proprietary assets, or claim official scoring, percentile or hiring-decision equivalence.
...
- `LAB` lighter/lime;
- secondary line `Client Advisory Workspace`.
